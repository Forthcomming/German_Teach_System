...
namespace DA_Assets.FCU.Extensions
{
    ...
    {
        public static bool IsPlaying(this FigmaConverterUnity fcu) => Application.isPlaying;
        ...
        public static bool UsingUI_Toolkit_Text(this FigmaConverterUnity fcu) =>
        ...
        public static bool UsingUI_Toolkit_Image(this FigmaConverterUnity fcu) =>
        ...
        public static bool UsingFlexibleImage(this FigmaConverterUnity fcu) =>
