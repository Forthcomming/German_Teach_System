...
namespace DA_Assets.FCU
{
    ...
    public class TmpDownloader : FcuBase
    {
        ...
        private async Task GenerateFont(FontStruct fs, CancellationToken token, Return<FontStruct> @return)
        {
            ...
            DAResult<string> unicodeRangeResult = await GetUnicodeRange(fs.FontMetadata.Family, fs.FontSubset, token);
        ...
        private async Task<DAResult<string>> GetUnicodeRange(string family, FontSubset fontSubset, CancellationToken token)
        {
            ...
            string css = (await monoBeh.RequestSender.SendRequest<string>(request, token)).Object;
        ...
        public int SamplingPointSize { get => samplingPointSize; set => samplingPointSize = value; }
        public int AtlasPadding { get => atlasPadding; set => atlasPadding = value; }
        public UnityEngine.TextCore.LowLevel.GlyphRenderMode RenderMode { get => renderMode; set => renderMode = value; }
        public int AtlasWidth { get => atlasWidth; set => atlasWidth = value; }
        public int AtlasHeight { get => atlasHeight; set => atlasHeight = value; }
#if TextMeshPro
        public AtlasPopulationMode AtlasPopulationMode { get => atlasPopulationMode; set => atlasPopulationMode = value; }
#endif
